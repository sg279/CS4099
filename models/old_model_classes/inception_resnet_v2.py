...
class inceptionResnet():
    ...
    def __init__(self, model_name = None, transformation_ratio = .05, trainable_base_layers = 0, resolution = 400, seed = 4099, model_dir="ensemble_members"):
        ...
        self.based_model_last_block_layer_number = 572  # value is based on based model selected.
    ...
    def make_model(self, load=False, extra_block=False):
        ...
        base_model = InceptionResNetV2(input_tensor=input, weights='imagenet', include_top=False)
